...
const Insurance = require("../model/insuranceSchema.js"); 
...
const submitForm = async (req, res, next) => {
  const { insuranceName, address } = req.body;
  const userEmail = req.user.email; // Assuming you have middleware to extract user information from the request

  try {
    // Create a new instance of the Insurance model with form data and user email
    ...
    // Save the new insurance form data to the database
